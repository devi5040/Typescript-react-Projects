...
const DisplayCard = () => {
    ...
    return <div className="border border-gray-500 rounded-2xl h-[10vh] relative">
        <p className="absolute right-5 top-0.5 text-gray-600 dark:text-gray-300 font-semibold text-md">{inputString}</p>
        <h1 className="absolute right-5 bottom-2 dark:text-white font-semibold text-3xl">{result}</h1>
    </div>
}
